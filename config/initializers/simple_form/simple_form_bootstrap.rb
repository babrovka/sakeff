...
SimpleForm.setup do |config|
  ...
  config.wrappers :short_field, tag: 'div', class: 'col-sm-12', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label, class: 'col-sm-2 control-label'
  ...
  config.wrappers :middle_field, tag: 'div', class: 'col-sm-12', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label, class: 'col-sm-2 control-label'

task :docflow_ziklon do
  ...
  set :user, "babrovka"
  set :application, "kzs"
  set :deploy_to, "/srv/webdata/docflow.ziklon.ru"
...
task :create_db do
  ...
  after "copy_sms_config", "deploy:create_symlink"

  after "deploy:create_symlink", "deploy:migrate"
  after "deploy:migrate", "import_permissions"
  after "import_permissions", "copy_and_import_units"
